    ...
    MuiCssBaseline: {
      styleOverrides: {
        body: {
          ...
          backgroundImage: 'radial-gradient(circle at 15% 50%, rgba(96, 165, 250, 0.08), transparent 25%), radial-gradient(circle at 85% 30%, rgba(167, 139, 250, 0.08), transparent 25%)',
